...
export const metadata: Metadata = {
  ...
  title: 'Changelog — What shipped recently | Build AI Starups',
  description:
    'All notable changes to Build AI Starups: features, improvements, fixes, and security notes.',
  ...
  openGraph: {
    ...
    images: [{ url: ogImage, width: 1200, height: 630, alt: 'Build AI Starups — Changelog' }],
...
const collectionJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'CollectionPage',
  name: 'Build AI Starups — Changelog',
  url: pageUrl,
  description:
    'Release notes for Build AI Starups: Builder, Ecosystem, Marketplace, API, Docs.',
}
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg text-slate-300">
                Every improvement to Build AI Starups. We track features, fixes, and security notes across
