// app/(default)/changelog/page.tsx
...
const CANON = `${SITE}/changelog`
const OG = '/brand/og-default.png'
const DESC =
  `Product updates and improvements to ${BRAND}. Follow along as we ship features, templates, and quality-of-life upgrades.`
