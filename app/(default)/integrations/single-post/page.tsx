// app/(default)/integrations/single-post/page.tsx
...
const CANON = `${SITE}/integrations/single-post`
const OG = '/brand/og-default.png'

export const metadata: Metadata = {
  metadataBase: new URL(SITE),
  title: 'GitHub Integration — Build AI Startups',
  description:
    'Connect GitHub to Build AI Startups to link PRDs, branches, and pull requests — keep work in sync automatically.',
  ...
  openGraph: {
    ...
    title: 'GitHub Integration — Build AI Startups',
    description:
      'Link PRs to issues, auto-update statuses, and ship with confidence using CI gates and previews.',
  ...
  twitter: {
    ...
    title: 'GitHub Integration — Build AI Startups',
    description:
      'Keep product work in sync from PRD to merged PR with the GitHub integration.',
    images: [OG],
  },
}
                    ...
                    <article className="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,var(--color-slate-800),transparent)1]">
                      <figure className="bg-slate-700/20 border border-slate-300/10 p-4 rounded-3xl mb-8">
                        <Image
                          ...
                          width={586}
                          height={316}
                          alt="GitHub integration overview"
                          priority
                        />
                      </figure>

                      <h1 className="sr-only">GitHub Integration</h1>
                      ...
                      <div className="prose max-w-none text-slate-400 prose-headings:text-slate-50 prose-h2:text-xl prose-h2:mt-8 prose-h2:mb-4 prose-p:leading-relaxed prose-a:text-purple-500 prose-a:no-underline hover:prose-a:underline prose-strong:text-slate-50 prose-strong:font-medium prose-blockquote:pl-5 prose-blockquote:xl:-ml-5 prose-blockquote:border-l-2 prose-blockquote:border-purple-500 prose-blockquote:font-medium prose-blockquote:text-slate-300 prose-blockquote:italic">
                        <h2>Overview</h2>
                        <p>
                          The GitHub integration keeps your work in sync in both
                          applications. It links features to Pull Requests so details
                          update automatically from <em>In&nbsp;Progress</em> to{' '}
                          <em>Done</em> as the PR moves from drafted to merged — no need
                          to update the issue in <strong>Build AI Startups</strong>.
                        </p>
                        <p>
                          Move even faster with a keyboard shortcut that creates the
                          issue’s branch name, assigns the issue, and moves it to
                          <em> In&nbsp;Progress</em> in one step. This integration
                          supports <a href="#0">GitHub Enterprise</a>.
                        </p>

                        <h2>How it works</h2>
                        <p>
                          Configure the GitHub integration in a couple of minutes by
                          authenticating and selecting which repos to connect to{' '}
                          <strong>Build AI Startups</strong>. Once connected, anyone in
                          the workspace can start linking PRs.
                        </p>
                        <p>
                          Link PRs to issues in a few ways: include the issue ID in the
                          branch name or PR title before creating the PR. To link
                          multiple PRs or link after opening, use magic words with the
                          issue ID in the PR description.
                        </p>
                      </div>
                    </article>

                    <aside className="pl-6 border-l-2 border-purple-500">
                      <p className="inline-flex font-medium italic text-lg bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
                        “This integration is so seamless it keeps our entire team
                        perfectly in sync from spec to ship.”
                      </p>
