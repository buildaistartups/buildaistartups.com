// app/(default)/integrations/integrations-section.tsx
    ...
    <section className="relative">
      ...
      >
        <Image
          ...
          width={1440}
          height={427}
          alt="Secondary page illustration"
        />
      </div>
      ...
      >
        <Image
          ...
          width={1440}
          height={427}
          alt="Integrations backdrop illustration"
        />
      </div>
        ...
        <div className="pt-32 md:pt-40">
          ...
          <div className="text-center pb-12 md:pb-20">
            ...
            <h1 className="h1 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Wire your stack to Build AI Starups
            </h1>
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-slate-400">
                Connect GitHub, Vercel, databases (Postgres/Supabase), Stripe, email,
                auth, and analytics. Your accounts, your keys, your data — no lock-in.
                Everything uses standard OAuth or API keys with least-privilege scopes.
              </p>
            </div>
          </div>
