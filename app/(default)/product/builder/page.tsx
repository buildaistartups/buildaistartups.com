...
export default async function BuilderPage({
  ...
  // Derived UI strings / images (fallback to general assets)
  const heroTitle = vertical?.title ?? 'From brief to repo in minutes'
  const heroTagline =
    vertical?.tagline ??
    'The Builder turns a plain-language intent into a production-ready app—spec, repo, UI, copy, docs, pricing, and deploy. No boilerplate. No waiting.'
  ...
  // UI workshop preview keeps your general shell:
  const shellPreview = '/images/product/builder/shell-preview.svg'
  ...
  return (
    <>
      ...
      <main className="bg-slate-950 text-slate-200">
        {/* Hero (title, tagline, hero image are vertical-aware) */}
        <section className="mx-auto max-w-6xl px-6 pb-10 pt-20 sm:pt-28">
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <h1 className="mt-2 text-4xl font-bold sm:text-5xl">{heroTitle}</h1>
              <p className="mt-4 text-lg text-slate-300">
                {heroTagline}
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <a
                  href={vertical ? `/generate?vertical=${vertical.id}` : '/generate'}
        ...
        {/* How it works: 5 steps (unchanged copy) */}
        ...
        {/* Split sections (images below swap by vertical) */}
        ...
        {/* Quality gates / Confidence (unchanged) */}
        <section className="mx-auto max-w-6xl px-6 py-12">
        ...
        {/* Example: tiny API flow (unchanged) */}
        <section className="mx-auto max-w-6xl px-6 py-12">
