      ...
      <section className="px-6 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: "🔒", title: "Security", items: ["Zero-trust architecture", "E2E encryption", "Penetration tested"] },
              { icon: "🛡️", title: "Compliance", items: ["SOC2 Type II", "GDPR/CCPA", "Custom policies"] },
              { icon: "🔐", title: "Authentication", items: ["SSO/SAML", "MFA support", "AD integration"] },
              { icon: "📊", title: "Analytics", items: ["Custom dashboards", "Export capabilities", "API access"] },
              { icon: "🌐", title: "Global Ready", items: ["Multi-language", "Multi-region", "Local compliance"] },
              { icon: "⚡", title: "Performance", items: ["Auto-scaling", "Load balancing", "CDN included"] },
              { icon: "🔧", title: "Customization", items: ["Custom workflows", "API extensions", "Plugin system"] },
              { icon: "🤝", title: "Support", items: ["24/7 availability", "Dedicated CSM", "SLA guarantees"] }
            ].map((feature, idx) => (
