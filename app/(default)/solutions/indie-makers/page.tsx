          ...
          <div className="flex justify-center mb-8">
            <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-5">
              <img 
                ...
                className="h-48 w-auto mx-auto object-cover rounded-lg"
                loading="lazy"
              />
            </div>
          </div>
          ...
          <div className="flex justify-center mb-8">
            <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-5">
              <img 
                ...
                className="h-32 w-auto mx-auto object-cover rounded-lg"
                loading="lazy"
              />
            </div>
          </div>
        ...
        <section className="mx-auto max-w-6xl px-6 py-12">
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={i} className="rounded-xl border border-white/10 bg-slate-900/40 p-4">
                <div className="aspect-video w-full overflow-hidden rounded-lg border border-white/10 bg-slate-900/50 p-5">
                  <img 
