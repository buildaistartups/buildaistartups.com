  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="btn w-full text-[var(--ls-text)] border border-[var(--ls-border)] bg-[var(--ls-card-bg)] hover:bg-[var(--ls-bg-alt)] transition h-11 disabled:opacity-50"
      >
        <svg className="w-5 h-5 fill-current mr-3 shrink-0" viewBox="0 0 16 16">
