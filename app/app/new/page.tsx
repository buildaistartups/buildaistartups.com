  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-2xl mx-auto">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">
        Give your startup a name. You can always change it later.
      </p>
      ...
      <form action={createProject} className="space-y-6">
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-400 mt-1">What does it do, in one sentence?</p>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <a
            href="/app/dashboard"
            className="btn border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-300 hover:border-gray-300 text-sm"
          >
            Cancel
          </a>
        </div>
