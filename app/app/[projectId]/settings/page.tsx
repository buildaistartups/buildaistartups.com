...
export default function ProjectSettingsPage() {
  ...
  async function handleDelete() {
    ...
    if (error) { alert('Failed to delete project'); setDeleting(false); return }
    ...
    <div className="max-w-2xl space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 border border-red-200 dark:border-red-500/30 rounded-xl p-6">
        ...
        <button onClick={handleDelete} disabled={deleting}
          className="btn text-sm bg-red-500 hover:bg-red-600 text-white disabled:opacity-50 rounded-xl">
