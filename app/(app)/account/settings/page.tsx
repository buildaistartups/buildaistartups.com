      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 rounded-xl p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Account ID: <code className="text-xs bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded">{user?.id}</code>
          </p>
        ...
        <div>
          ...
          <button className="btn text-sm bg-red-500 hover:bg-red-600 text-white" disabled>
