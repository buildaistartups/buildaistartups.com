...
export default function BillingPage() {
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-2xl mx-auto">
      ...
      {/* Upgrade CTA */}
      <div className="bg-violet-500/5 border-2 border-violet-500/30 rounded-xl p-6">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Upgrade to Pro</h2>
        ...
        <button className="btn bg-violet-500 hover:bg-violet-600 text-white text-sm shadow-sm" disabled>
          Upgrade — Coming Soon
        </button>
        <p className="text-xs text-gray-400 mt-2">Stripe payments will be available in Week 5.</p>
      </div>
    </div>
  )
}
