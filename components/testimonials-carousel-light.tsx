      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            {/* Title — force solid color, remove any gradient/transparent overrides */}
            <h2
              className="h2 pb-4"
              style={{
                color: '#0f172a',              // slate-900-ish for strong contrast
                background: 'none',
                WebkitBackgroundClip: 'initial',
            ...
            {/* Subtext — readable neutral; also hard-reset any background-clip */}
            <p
              className="text-lg"
              style={{
