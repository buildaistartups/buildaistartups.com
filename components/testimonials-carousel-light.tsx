...
export default function TestimonialsCarouselLight() {
  ...
  useEffect(() => {
    // Initialize Swiper
    // NOTE: scope your selector to this section if you might have more than one carousel on a page
    // e.g. add an id to the root section and query inside it.
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <div>
              {/* Solid color (no gradient) for light theme eyebrow */}
              <div
