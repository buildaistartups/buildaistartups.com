      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Eyebrow line — gradient for dark mode, solid lavender in light mode via .light .eyebrow-text */}
            <div className="mb-2" data-aos="fade-down">
              <div className="inline-flex font-medium pb-3 eyebrow-text bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-300">
            ...
            <p
              className="text-lg text-slate-300 mb-8 hero-subtext"
              data-aos="fade-down"
              data-aos-delay="200"
            >
            ...
            >
              <div>
                {/* cta-primary keeps white CTA readable in light mode */}
                <a
