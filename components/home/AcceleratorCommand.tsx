        ...
        <div className="py-12 md:py-20">
          ...
          <div className="bg-slate-800/50 rounded-xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { title: 'Cohort Batch Manager', desc: 'Track 50 startups at once' },
                { title: 'Mentor Assignment AI', desc: 'Perfect expertise matching' },
                { title: 'Demo Day Builder', desc: 'Auto-generate pitch decks' },
                { title: 'Program Analytics', desc: 'Real-time success metrics' },
                { title: 'Graduation Gateway', desc: 'Automated milestone tracking' },
                { title: 'Investor Network', desc: 'Direct access to 500+ VCs' }
              ].map((tool) => (
