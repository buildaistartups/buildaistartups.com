  ...
  return (
    <section>
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Illustration (same placement as dark) */}
        <div
          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
                {/* Eyebrow — solid purple for light */}
                <div>
                  <div
              ...
              {/* Right column — identical halo/grid/particles block as dark theme */}
                ...
                <div className="relative py-24 -mt-12">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative w-48 h-48 flex justify-center items-center">
                      ...
                      {/* Center icon transitions (same logic as dark) */}
                      <Transition
                        as="div"
                        show={tab === 1}
      ...
      {/* Light-only tab color overrides */}
      <style jsx>{`
        ...
        :global(html.light) .feature-tab[aria-pressed="true"] {
          color: #0f172a !important;                    /* selected = black */
          background: rgba(255,255,255,0.85) !important;
          border-color: #7c3aed !important;             /* purple ring */
