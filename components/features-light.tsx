// app/components/features-light.tsx
'use client'
          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div
                ...
                data-aos="fade-down"
              >
                {/* Eyebrow — SOLID lavender for light mode, no gradient */}
                <div>
                  <div
                    className="
                      inline-flex font-medium pb-3
                      text-[var(--color-purple-200)]
                    "
                  >
                ...
                <p className="text-lg mb-8 text-[var(--color-slate-200)]">
              ...
              <div className="md:w-5/12 lg:w-1/2" data-aos="fade-up" data-aos-delay="100">
                <div className="relative py-24 -mt-12">
                  ...
                  {/* … keep your icon halo + grid exactly as in dark/original … */}
                </div>
              </div>
            </div>
          </div>
