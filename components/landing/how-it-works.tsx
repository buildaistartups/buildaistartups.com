...
export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Your LaunchScore (0-100) tells you — honestly — whether to persevere, pivot, or sunset. Based on real evidence, not vibes. Updated weekly as you collect more data.',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
