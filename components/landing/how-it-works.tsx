  ...
  const steps = [
    {
      ...
      description: 'Enter your startup idea in plain English. Our AI analyzes the market, identifies competitors, profiles your ideal customer, and gives you an honest validation score.',
      icon: (
