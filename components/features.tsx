          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
                <div>
                  <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-300 pb-3">
                    The security first platform
                  </div>
                </div>
                <h3 className="h3 text-slate-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-r dark:from-slate-200/60 dark:via-slate-200 dark:to-slate-200/60 pb-3">
                ...
                <div className="mt-8 max-w-xs max-md:mx-auto space-y-2">
                  <button
                    className={`flex items-center text-sm font-medium rounded-sm border w-full px-3 py-2 transition duration-150 ease-in-out
                      ${tab !== 1
                        ? 'text-slate-700 bg-white border-slate-200 opacity-60 dark:text-slate-50 dark:bg-slate-800/25 dark:border-slate-700'
                        : 'text-white bg-gradient-to-r from-purple-500 to-purple-700 border-purple-700 shadow-sm shadow-purple-500/25 opacity-100'
                      } hover:opacity-100`}
                    onClick={() => setTab(1)}
                  >
                    <svg className="shrink-0 mr-3 fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
