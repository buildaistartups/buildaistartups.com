    ...
    <section>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                ...
                <p className="feature-subtext text-lg mb-8 dark:text-slate-400">
                  Describe your idea in a sentence. Build AI Startups researches the niche, drafts
                  the product spec, scaffolds a production-ready repo, ships the UI &amp; docs, wires
                  auth/billing/analytics, and deploys. You keep everything under your own GitHub,
                  Vercel, and Stripe.
                </p>
      ...
      <style jsx>{`
        ...
        .ai-orb__halo {
          ...
          inset: -10vmax;
          background:
            radial-gradient(45% 55% at 50% 40%, rgba(20, 184, 166, 0.1), transparent 60%),
            radial-gradient(65% 55% at 50% 60%, rgba(99, 102, 241, 0.1), transparent 60%),
          ...
          filter: blur(24px);
          animation: ai-orb-spin 38s linear infinite;
          opacity: 0.75;
          pointer-events: none;
        }
        ...
        .ai-orb__ring.r1 {
          animation: ai-orb-tilt1 16s linear infinite;
        }
        .ai-orb__ring.r2 {
          animation: ai-orb-tilt2 21s linear infinite reverse;
        }
        .ai-orb__ring.r3 {
          animation: ai-orb-tilt3 27s linear infinite;
        }
        @keyframes ai-orb-tilt1 {
          to {
            transform: rotateX(65deg) rotateZ(360deg);
          }
        }
        @keyframes ai-orb-tilt2 {
          to {
            transform: rotateY(65deg) rotateZ(-360deg);
          }
        }
        @keyframes ai-orb-tilt3 {
          to {
        ...
        .ai-orb__signals path {
          ...
          animation: ai-orb-dash 3.2s linear infinite;
          opacity: 0.8;
        }
        @keyframes ai-orb-dash {
          to {
        ...
        .ai-orb__chip.c1 {
          animation: ai-orb-orbit1 12s linear infinite;
        }
        .ai-orb__chip.c2 {
          animation: ai-orb-orbit2 18s linear infinite reverse;
        }
        .ai-orb__chip.c3 {
          animation: ai-orb-orbit3 22s linear infinite;
        }
        @keyframes ai-orb-orbit1 {
          from {
