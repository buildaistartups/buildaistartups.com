...
import AiOrbGlass from './ai-orb-glass'
              ...
              <div className="md:w-5/12 lg:w-1/2" data-aos="fade-up" data-aos-delay="100">
                <div className="relative py-24 -mt-12">
                  ...
                  <div className="flex items-center justify-center">
                    <AiOrbGlass active={tab as 1 | 2 | 3} size={520}>
                      {/* Replace with your SVG/logo if desired */}
                      <div style={{ display: 'grid', gap: 4, textAlign: 'center', transform: 'translateY(-2px)' }}>
                        <strong style={{ color: 'rgba(241,245,249,.98)', fontWeight: 800, letterSpacing: '.3px' }}>
                          Build AI
                        </strong>
                        <span style={{ color: 'rgba(226,232,240,.92)' }}>Startups</span>
                      </div>
                    </AiOrbGlass>
                  </div>
                </div>
