      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Title */}
            <h1
              className="h1 bg-clip-text text-transparent bg-linear-to-r from-slate-800/60 via-slate-800 to-slate-800/60 pb-4"
              data-aos="fade-down"
            >
            ...
            {/* Subtext */}
            <p
              className="text-lg text-slate-700 mb-3 hero-subtext"
              data-aos="fade-down"
              data-aos-delay="200"
            >
            ...
            <p className="text-sm font-medium text-purple-600/95 mb-4">
