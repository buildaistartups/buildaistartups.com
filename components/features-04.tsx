          ...
          <div className="divide-y divide-slate-200 dark:divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-purple-400 dark:fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Discussions</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Team views</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Powerful search</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Analytics</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Notifications</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Integrations</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Privacy</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Data export</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-lg p-6">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-900 dark:text-slate-50">Real-time sync</h4>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
