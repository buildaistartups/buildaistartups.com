        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Why teams trust Build AI Startups
            </h2>
            <p className="text-lg text-slate-400">
              Own your code, infra, and data. Build AI Startups generates production-grade Next.js apps,
              pushes to <strong>your GitHub</strong>, deploys to <strong>your Vercel</strong>,
              and wires billing/analytics to <strong>your Stripe</strong> — with every change tracked and reviewable.
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16" aria-hidden="true">
                    ...
                    <h4 className="font-medium text-slate-50">Spec-reviewed PRs</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Your one-line brief becomes a PRD with acceptance criteria. Every change lands as a reviewable PR.
                  </p>
                </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Changelog &amp; team views</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Auto-curated release notes and dashboards for PM, Eng, and Growth — no extra tooling.
                  </p>
                </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Universal search</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    One place to find specs, issues, commits, and docs across your repo.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">GitHub-first analytics</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Usage signals flow back into issues and PRs so you ship what moves metrics.
                  </p>
                </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Vercel previews &amp; alerts</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Each PR gets a preview URL with checks and notifications wired out of the box.
                  </p>
                </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Adapters &amp; integrations</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Stripe, Postgres/Supabase, S3, email, auth — swap or extend with simple adapters.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Your cloud, your data</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    No hidden backends. Deploy under your accounts; keep full ownership and access.
                  </p>
                </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Portable by default</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Specs, docs, and data models live as Markdown in your repo — export anytime.
                  </p>
                </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Audit trail &amp; realtime sync</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Specs, issues, commits, and deploys stay in sync with a complete audit history.
                  </p>
                </div>
              </div>
            </div>
