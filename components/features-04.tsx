          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                ...
                <div className="inline-flex font-medium pb-6 eyebrow-text">API Authorization</div>
              </div>
            ...
            <div className="py-8">
              <div>
                {/* solid lavender in light mode */}
                <div className="inline-flex font-medium pb-6 eyebrow-text">User Management</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
            ...
            <div className="py-8">
              <div>
                {/* solid lavender in light mode */}
                <div className="inline-flex font-medium pb-6 eyebrow-text">Standard Security</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
