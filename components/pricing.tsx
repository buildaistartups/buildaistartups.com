...
export default function Pricing() {
  ...
  // Reusable border utility for all row separators
    ...
    <div className="relative">
      ...
      <div className="grid md:grid-cols-4 xl:-mx-6 text-sm [&>div:nth-of-type(-n+4)]:py-6 [&>div:nth-last-of-type(-n+4)]:pb-6 max-md:[&>div:nth-last-of-type(-n+4)]:mb-8 max-md:[&>div:nth-of-type(-n+4):nth-of-type(n+1)]:rounded-t-3xl max-md:[&>div:nth-last-of-type(-n+4)]:rounded-b-3xl md:[&>div:nth-of-type(2)]:rounded-tl-3xl md:[&>div:nth-of-type(4)]:rounded-tr-3xl md:[&>div:nth-last-of-type(3)]:rounded-bl-3xl md:[&>div:nth-last-of-type(1)]:rounded-br-3xl [&>div]:bg-slate-700/20 [&>div:nth-of-type(4n+1)]:bg-transparent max-md:[&>div:nth-of-type(4n+5)]:hidden max-md:[&>div:nth-of-type(4n+2)]:order-1 max-md:[&>div:nth-of-type(4n+3)]:order-2 max-md:[&>div:nth-of-type(4n+4)]:order-3 max-md:md:[&>div:nth-of-type(n)]:mb-0 [&>div:nth-of-type(4n+3)]:relative [&>div:nth-of-type(4n+3)]:before:absolute [&>div:nth-of-type(4n+3)]:before:-inset-px [&>div:nth-of-type(4n+3)]:before:rounded-[inherit] [&>div:nth-of-type(4n+3)]:before:border-x-2 [&>div:nth-of-type(3)]:before:border-t-2 [&>div:nth-last-of-type(2)]:before:border-b-2 [&>div:nth-of-type(4n+3)]:before:border-purple-500 [&>div:nth-of-type(4n+3)]:before:-z-10 [&>div:nth-of-type(4n+3)]:before:pointer-events-none">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className={`pb-5 md:border-b border-slate-200 dark:border-slate-800`}>
            {/* Toggle switch */}
        ...
        {/* Pro price */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`grow pb-4 mb-4 ${rowBorder}`}>
        ...
        {/* Social Connections */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Social Connections</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center h-full ${rowBorder} py-2 text-slate-400`}>
        ...
        {/* Custom Domains */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Custom Domains</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center h-full ${rowBorder} py-2 text-slate-400`}>
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>User Role Management</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center h-full ${rowBorder} py-2 text-slate-400`}>
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* External Databases */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>External Databases</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center h-full ${rowBorder} py-2 text-slate-400`}>
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Custom Connection */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Custom Connection</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center h-full ${rowBorder} py-2 text-slate-400`}>
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Advanced Deployment Options</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center h-full ${rowBorder} py-2 text-slate-400`}>
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Extra Add-ons */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Extra Add-ons</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center h-full ${rowBorder} py-2 text-slate-400`}>
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Admin Roles */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Admin Roles</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center ${rowBorder} py-2 text-slate-400 max-md:hidden`}>
            <span>
        ...
        {/* Deploy and Monitor */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Deploy and Monitor</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center ${rowBorder} py-2 text-slate-400 max-md:hidden`}>
            <span>
        ...
        {/* Enterprise Add-ons */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Enterprise Add-ons</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center ${rowBorder} py-2 text-slate-400 max-md:hidden`}>
            <span>
        ...
        {/* Premium Support */}
        <div className="px-6 flex flex-col justify-end">
          <div className={`py-2 text-slate-400 ${rowBorder}`}>Premium Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className={`flex items-center ${rowBorder} py-2 text-slate-400 max-md:hidden`}>
            <span>
