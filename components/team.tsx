...
const items: Item[] = [
  { img: Member01, name: 'Sarah Barnekow', role: 'CEO & Co-founder', twitter: '#0' },
  { img: Member02, name: 'Alex Suevalov', role: 'Tech Lead', twitter: '#0' },
  { img: Member03, name: 'Mark Lamprecht', role: 'Software Engineer', twitter: '#0' },
  { img: Member04, name: 'Scott Bailey', role: 'Software Engineer', twitter: '#0' },
  { img: Member05, name: 'Vedant Hegde', role: 'Customer Experience', twitter: '#0' },
  { img: Member06, name: 'Lucy Radux', role: 'Marketing Manager', twitter: '#0' },
  { img: Member07, name: 'Devani Janssen', role: 'Product Design', twitter: '#0' },
  { img: Member08, name: 'Dima Trystram', role: 'Customer Success', twitter: '#0' },
  { img: Member09, name: 'Fraser Davidson', role: 'Customer Success', twitter: '#0' },
  { img: Member10, name: 'William Adkins', role: 'Customer Experience', twitter: '#0' },
  { img: Member11, name: 'Debbie Poulin', role: 'Head of Talent', twitter: '#0' },
  { img: Member12, name: 'James Kudinov', role: 'Product Design', twitter: '#0' },
  { img: Member13, name: 'Zhenya Rynzhuk', role: 'Software Engineer', twitter: '#0' },
  { img: Member14, name: 'Mary Maka', role: 'Enterprise Architect', twitter: '#0' },
  { img: Member15, name: 'Monty Hayton', role: 'Video Producer', twitter: '#0' },
  { img: Member16, name: 'Srdjan Vidakovic', role: 'Operations Manager', twitter: '#0' },
  { img: Member17, name: 'David Cran', role: 'Financial Analyst', twitter: '#0' },
  { img: Member18, name: 'Jacek Janiczak', role: 'Data Engineer', twitter: '#0' },
  { img: Member19, name: 'Tommy Chandra', role: 'Head of Design', twitter: '#0' },
  { img: Member20, name: 'Ally Golovko', role: 'Software Engineer', twitter: '#0' },
]
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              Various versions of Lorem Ipsum have evolved over the years, sometimes by accident, sometimes on purpose, and by injecting humour and the like.
            </p>
          </div>
          {/* Team members */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-6">
            {items.map((item, i) => (
              ...
              >
                ...
                <a
                  className="shrink-0 text-slate-500 md:opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100 focus:outline-none"
                  href={item.twitter}
                  aria-label={`${item.name}'s Twitter`}
                  target={item.twitter !== '#0' ? "_blank" : undefined}
                  rel={item.twitter !== '#0' ? "noopener noreferrer" : undefined}
                  tabIndex={item.twitter === '#0' ? -1 : 0}
                >
