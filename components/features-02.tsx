          ...
          <div className="relative pb-12 md:pb-20">
            ...
            <Highlighter className="grid md:grid-cols-12 gap-6 group">
              ...
              <div className="md:col-span-12" data-aos="fade-down">
                <HighlighterItem>
                  <div className="relative h-full bg-white dark:bg-slate-900 shadow-lg rounded-[inherit] border border-slate-100 dark:border-slate-800 z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        <div className="mb-5">
                          <div>
                            <h3 className="inline-flex text-xl font-bold text-slate-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-r dark:from-slate-200/60 dark:via-slate-200 dark:to-slate-200/60 pb-1">Optimized for security</h3>
                            <p className="text-slate-700 dark:text-slate-400">Optimize for user experience and privacy. Use social login integrations, lower user friction, incorporate rich user profiling, and facilitate more transactions.</p>
                          </div>
                        </div>
                        <div>
                          <a className="btn-sm bg-purple-600 hover:bg-purple-700 text-white font-semibold px-5 py-2 rounded-xl shadow transition duration-150 ease-in-out" href="#0">
                            Learn more <span className="tracking-normal text-purple-100 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                          </a>
                        </div>
                      </div>
                      {/* Image */}
                  ...
                  <div className="relative h-full bg-white dark:bg-slate-900 shadow-lg rounded-[inherit] border border-slate-100 dark:border-slate-800 z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold text-slate-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-r dark:from-slate-200/60 dark:via-slate-200 dark:to-slate-200/60 pb-1">Extensibility</h3>
                          <p className="text-slate-700 dark:text-slate-400">Your login box must find the right balance between user convenience, privacy and security.</p>
                        </div>
                      </div>
                      {/* Image */}
                ...
                <HighlighterItem>
                  <div className="relative h-full bg-white dark:bg-slate-900 shadow-lg rounded-[inherit] border border-slate-100 dark:border-slate-800 z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold text-slate-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-r dark:from-slate-200/60 dark:via-slate-200 dark:to-slate-200/60 pb-1">Infinite options</h3>
                          <p className="text-slate-700 dark:text-slate-400">Quickly apply filters to refine your issues lists and create custom views.</p>
                        </div>
                      </div>
                      {/* Image */}
                      <div className="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <svg className="shrink-0 fill-slate-500 dark:fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                ...
                <h4 className="font-medium text-slate-900 dark:text-slate-50">Filters</h4>
              </div>
              <p className="text-sm text-slate-700 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900 dark:text-slate-50">Configurable</h4>
              </div>
              <p className="text-sm text-slate-700 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900 dark:text-slate-50">Adaptable</h4>
              </div>
              <p className="text-sm text-slate-700 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900 dark:text-slate-50">Authorization</h4>
              </div>
              <p className="text-sm text-slate-700 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900 dark:text-slate-50">Management</h4>
              </div>
              <p className="text-sm text-slate-700 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900 dark:text-slate-50">Building</h4>
              </div>
              <p className="text-sm text-slate-700 dark:text-slate-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
          </div>
