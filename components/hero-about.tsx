        ...
        <div className="pt-32 pb-10 md:pt-40">
          ...
          <div className="text-center">
            <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-3">
              The team behind Build AI Startups
            </div>
            <h1 className="h1 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-6">
              We build startups that build themselves
            </h1>

            {/* Rings illustration */}
            <div className="inline-flex items-center justify-center relative">
              {/* Particles animation (canvas hook) */}
              <div className="absolute inset-0 -z-10" aria-hidden="true">
                <canvas data-particle-animation data-particle-quantity="10" />
              </div>
              ...
              <div className="inline-flex [mask-image:_radial-gradient(circle_at_bottom,transparent_15%,black_70%)]">
                <Image
                  ...
                  width={446}
                  height={446}
                  alt="About Build AI Startups illustration"
                  priority
                />
              </div>
