...
export default function PricingLight() {
  ...
  return (
    <div className="relative">
      {/* Blurred shape (kept) */}
      <div
        className="max-md:hidden absolute bottom-0 -mb-20 left-2/3 -translate-x-1/2 blur-2xl opacity-60 pointer-events-none"
        aria-hidden="true"
      >
      ...
      <div
        className={[
          ...
          // card backgrounds to light grey, first column (features list) stays transparent
          '[&>div]:!bg-gray-100 [&>div:nth-of-type(4n+1)]:!bg-transparent',
          // mobile ordering behavior (unchanged)
          ...
          // purple selector outline around the middle column
      ...
      >
        ...
        <div className="px-6 flex flex-col justify-end">
          ...
          <div className="pb-4 border-b !border-gray-200">
            <a className="btn-sm !text-slate-900 bg-linear-to-r from-white/90 via-white to-white/90 hover:bg-white w-full transition duration-150 ease-in-out group" href="#0">
              Get Started{' '}
        ...
        <div className="px-6 flex flex-col justify-end">
          ...
          <div className="pb-4 border-b !border-gray-200">
            <a className="btn-sm text-white bg-purple-600 hover:bg-purple-700 w-full transition duration-150 ease-in-out group" href="#0">
              Get Started{' '}
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4 md:hidden">Usage</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4 md:hidden">Usage</div>
        </div>
        ...
        {/* Social Connections */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Social Connections</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b !border-gray-200 py-2 !text-slate-700">
        ...
        {/* Custom Domains */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Custom Domains</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b !border-gray-200 py-2 !text-slate-700">
            <svg className="shrink-0 fill-purple-600 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">User Role Management</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b !border-gray-200 py-2 !text-slate-700">
            <svg className="shrink-0 fill-purple-600 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* External Databases */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">External Databases</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b !border-gray-200 py-2 !text-slate-700">
            <svg className="shrink-0 fill-purple-600 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* # Features label */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4">Features</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4 md:hidden">Features</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4 md:hidden">Features</div>
        </div>
        ...
        {/* Custom Connection */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Custom Connection</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b !border-gray-200 py-2 !text-slate-700">
            <svg className="shrink-0 fill-purple-600 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Advanced Deployment Options</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b !border-gray-200 py-2 !text-slate-700">
            <svg className="shrink-0 fill-purple-600 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Extra Add-ons */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Extra Add-ons</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b !border-gray-200 py-2 !text-slate-700">
            <svg className="shrink-0 fill-purple-600 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Admin Roles */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Admin Roles</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
        ...
        {/* Deploy and Monitor */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Deploy and Monitor</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b !border-gray-200 py-2 !text-slate-700 max-md:hidden">
            <span>
        ...
        {/* Enterprise Add-ons */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Enterprise Add-ons</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b !border-gray-200 py-2 !text-slate-700 max-md:hidden">
            <span>
        ...
        {/* # Support label */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4">Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4 hidden">Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4 md:hidden">Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-900 font-semibold mt-4 md:hidden">Support</div>
        </div>
        ...
        {/* Premium Support */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 !text-slate-700 border-b !border-gray-200">Premium Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b !border-gray-200 py-2 !text-slate-700 max-md:hidden">
            <span>
