      ...
      >
          ...
          <div className="pb-5 md:border-b border-gray-300">
            <div className="max-md:text-center">
              <div className="inline-flex items-center whitespace-nowrap">
                <div className="text-sm text-gray-600 font-medium mr-2 md:max-lg:hidden">
                  Monthly
                </div>
                <div className="relative">
                  <input
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="grow pb-4 mb-4 border-b border-gray-300">
            <div className="text-base font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-600 to-purple-400 pb-0.5">
              Pro
            </div>
            <div className="mb-1">
            ...
            <div className="text-gray-600">Everything at your fingertips.</div>
          </div>
          <div className="pb-4 border-b border-gray-300">
            <a
              className="btn-sm text-gray-900 bg-linear-to-r from-white/80 via-white to-white/80 hover:bg-white w-full transition duration-150 ease-in-out group"
              href="#0"
            >
              Get Started{' '}
        ...
        {/* # Usage */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4">Usage</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4 md:hidden">Usage</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4 md:hidden">Usage</div>
        </div>
        ...
        {/* Social Connections */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-600 border-b border-gray-300">
            Social Connections
          </div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-gray-300 py-2 text-gray-600">
            <svg
        ...
        {/* # Features */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4">Features</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4 md:hidden">
            Features
          </div>
        </div>
        <div className="px-6 flex flex-col justify-end">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b border-gray-300 py-2 text-gray-600 max-md:hidden">
            <span>
        ...
        {/* # Support */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4">Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4 hidden">Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4 md:hidden">Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-gray-900 font-medium mt-4 md:hidden">Support</div>
        </div>
