...
export default function PricingLight() {
  ...
  return (
    <div className="relative">
      {/* Blurred shape (kept for subtle vibe) */}
      <div
      ...
      <div className="grid md:grid-cols-4 xl:-mx-6 text-sm [&>div:nth-of-type(-n+4)]:py-6 [&>div:nth-last-of-type(-n+4)]:pb-6 max-md:[&>div:nth-last-of-type(-n+4)]:mb-8 max-md:[&>div:nth-of-type(-n+4):nth-of-type(n+1)]:rounded-t-3xl max-md:[&>div:nth-last-of-type(-n+4)]:rounded-b-3xl md:[&>div:nth-of-type(2)]:rounded-tl-3xl md:[&>div:nth-of-type(4)]:rounded-tr-3xl md:[&>div:nth-last-of-type(3)]:rounded-bl-3xl md:[&>div:nth-last-of-type(1)]:rounded-br-3xl
        ...
        [&>div:nth-of-type(4n+3)]:relative [&>div:nth-of-type(4n+3)]:before:absolute [&>div:nth-of-type(4n+3)]:before:-inset-px [&>div:nth-of-type(4n+3)]:before:rounded-[inherit]
        [&>div:nth-of-type(4n+3)]:before:border-x-2 [&>div:nth-of-type(3)]:before:border-t-2 [&>div:nth-last-of-type(2)]:before:border-b-2
        [&>div:nth-of-type(4n+3)]:before:border-purple-500 [&>div:nth-of-type(4n+3)]:before:-z-10 [&>div:nth-of-type(4n+3)]:before:pointer-events-none
      ">
        {/* Pricing toggle */}
            ...
            <div className="max-md:text-center">
              <div className="inline-flex items-center whitespace-nowrap">
                ...
                <div className="relative">
                  ...
                  <label
                    htmlFor="toggle"
                    className="relative flex h-6 w-11 cursor-pointer items-center rounded-full bg-slate-300 px-0.5 outline-slate-400 transition-colors
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="grow pb-4 mb-4 border-b border-slate-200">
            ...
            <div className="text-slate-800">Everything at your fingertips.</div>
          </div>
          <div className="pb-4 border-b border-slate-200">
            <a
              className="btn-sm text-slate-900 bg-linear-to-r from-white/90 via-white to-white/90 hover:bg-white w-full transition duration-150 ease-in-out group"
              href="#0"
            >
              Get Started{' '}
        ...
        <div className="px-6 flex flex-col justify-end">
          ...
          <div className="pb-4 border-b border-slate-200">
            ...
            >
              Get Started{' '}
              <span className="tracking-normal text-purple-100 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                -&gt;
              </span>
            </a>
          </div>
        ...
        {/* Social Connections */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Social Connections</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-slate-200 py-2 text-slate-800">
        ...
        {/* Custom Domains */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Custom Domains</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-slate-200 py-2 text-slate-800">
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">User Role Management</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-slate-200 py-2 text-slate-800">
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* External Databases */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">External Databases</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-slate-200 py-2 text-slate-800">
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Custom Connection */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Custom Connection</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-slate-200 py-2 text-slate-800">
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Advanced Deployment Options</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-slate-200 py-2 text-slate-800">
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Extra Add-ons */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Extra Add-ons</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center h-full border-b border-slate-200 py-2 text-slate-800">
            <svg className="shrink-0 fill-purple-500 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
        ...
        {/* Admin Roles */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Admin Roles</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b border-slate-200 py-2 text-slate-800 max-md:hidden">
            <span>
        ...
        {/* Deploy and Monitor */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Deploy and Monitor</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b border-slate-200 py-2 text-slate-800 max-md:hidden">
            <span>
        ...
        {/* Enterprise Add-ons */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Enterprise Add-ons</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b border-slate-200 py-2 text-slate-800 max-md:hidden">
            <span>
        ...
        {/* Premium Support */}
        <div className="px-6 flex flex-col justify-end">
          <div className="py-2 text-slate-800 border-b border-slate-200">Premium Support</div>
        </div>
        <div className="px-6 flex flex-col justify-end">
          <div className="flex items-center border-b border-slate-200 py-2 text-slate-800 max-md:hidden">
            <span>
