        ...
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <a
                href="/resources/docs"
                className="btn text-slate-300 border border-slate-700/60 bg-slate-800/25 hover:bg-slate-800/40 transition duration-150 ease-in-out"
              >
                Read the docs
              </a>
            </div>
