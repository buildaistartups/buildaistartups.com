...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Sun SVG */}
        <svg width="8" height="8" fill="none" stroke="currentColor" strokeWidth="0.9" viewBox="0 0 24 24" aria-hidden="true">
      ...
      >
        {/* Moon SVG */}
        <svg width="7" height="7" fill="none" stroke="currentColor" strokeWidth="0.9" viewBox="0 0 24 24" aria-hidden="true">
          <path
